...
<template>
  <div class="dropdown dropdown-hover dropdown-end">
    <label tabindex="0" class="btn rounded-full normal-case text-white bg-white-30 hover:!bg-primary focus:!bg-primary border border-white-10 m-1 !px-6 py-2 truncate !inline-flex">
    ...
    <div tabindex="0" class="dropdown-content menu shadow p-2 bg-slate-900 border border-primary rounded w-52 md:!w-64 overflow-auto">
      ...
      <div>
        ...
        <RouterLink to="/wallet/accounts">
          <div class="block py-2 px-2 hover:!bg-slate-800 rounded cursor-pointer">Accounts</div>
        </RouterLink>
        <RouterLink to="/wallet/portfolio">
          <div class="block py-2 px-2 hover:!bg-slate-800 rounded cursor-pointer">Portfolio</div>
        </RouterLink>
  ...
  <Teleport to="body">
    <ping-connect-wallet class="ping-connect-wallet" :chain-id="baseStore.currentChainId" :hd-path="chainStore.defaultHDPath"
