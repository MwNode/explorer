...
<template>
  <div v-if="account">
    ...
    <div class="bg-white-10 px-4 pt-3 pb-4 rounded mb-4 shadow">
      <div class="flex items-center">
        ...
        <div class="inline-flex relative w-11 h-11 rounded-md">
          <div
            class="w-11 h-11 absolute rounded-md opacity-20 !bg-primary"
          ></div>
          <div
    ...
    <div class="bg-white-10 px-4 pt-3 pb-4 rounded mb-4 shadow">
      <div class="flex justify-between">
        ...
        <div class="flex justify-end mb-4 pr-5">
            <label
              for="send"
              class="btn btn-mw-primary btn-sm mr-2"
              @click="dialog.open('send', {}, updateEvent)"
              >{{ $t('account.btn_send') }}</label
            >
            <label
              for="transfer"
              class="btn btn-mw-primary btn-sm"
              @click="
                dialog.open(
                  'transfer',
                  {
        ...
        <div class="mt-4 md:!col-span-2 md:!mt-0 md:!ml-4">          
          ...
          <div class="">
            ...
            >
              ...
              >
                <span
                  class="inset-x-0 inset-y-0 opacity-20 absolute !bg-primary text-sm"
                ></span>
          ...
          <div class="mt-4 text-lg font-semibold mr-5 pl-5 border-t border-white-10 pt-4 text-right text-main">
            ...
            <tr v-for="(v, index) in delegations" :key="index">
              ...
              <td class="py-3">
                <div v-if="v.balance" class="flex justify-end">
                  <label
                    for="delegate"
                    class="btn btn-mw-primary btn-xs mr-2"
                    @click="
                      dialog.open(
                        'delegate',
                        {
                  ...
                  <label
                    for="unbond"
                    class="btn btn-mw-primary btn-xs"
                    @click="
                      dialog.open(
                        'unbond',
                        {
    ...
    <div
      class="bg-white-10 rounded mb-4 shadow"
    ...
    <!-- Account -->
    <div class="bg-white-10 rounded mb-4 shadow">
      <h2 class="card-title p-4">{{ $t('account.acc') }}</h2>
