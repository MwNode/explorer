...
<template>
  <div>
    <div class="bg-white-10 px-4 pt-3 pb-4 rounded shadow border-indigo-500">
    ...
    <div v-if="delegations.delegation_responses" class="mt-5 bg-white-10 shadow rounded p-4 ">
