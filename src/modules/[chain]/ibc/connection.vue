  ...
  <div>
    <div class="bg-white-10 px-4 pt-3 pb-4 rounded shadow">
      <div class="flex flex-wrap gap-4  items-center">
        ...
        <div class="tabs">
          <a class="tab mr-10" :class="{ 'tab-active': tab === 'registry' }" @click="tab = 'registry'">{{ $t('ibc.registry') }}</a>
      ...
      <div>
        ...
        <div v-show="tab === 'favorite'" class="flex flex-wrap gap-1 p-4 ">
          <div class="join border border-primary">
            ...
            <button class="join-item btn  btn-mw-primary" @click="ibcStore.showConnection()">{{ $t('ibc.btn_apply') }}</button>
          </div>
        </div>
      </div>
