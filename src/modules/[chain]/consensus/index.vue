  ...
  <div>
    ...
    <div class="bg-white-10 px-4 pt-3 pb-4 rounded shadow">
      <div class="form-control">
        <label class="input-group input-group-md w-full flex">
          ...
          <button class="btn btn-mw-primary" @click="onChange">{{ $t('consensus.monitor') }}</button>
        </label>
      </div>
    ...
    <div class="mt-4" v-if="roundState['height/round/step']">
      <div class="grid grid-cols-1 md:!grid-cols-4 auto-cols-auto gap-4 pb-4">
        <div
          class="bg-white-10 px-4 py-3 rounded shadow flex justify-between items-center"
        >
    ...
    <!-- update -->
    <div
      class="bg-white-10 p-4 rounded shadow"
